...
// import styles 
import { StyledTextFieldContact, linkStyle, StyledTextFieldContactMobile } from '../../assests/styles/styledComponents';
...
const Contact = (props) => {
    ...
    return (
        matches ?
                ...
                <div style={{ maxWidth: "600px", display: "flex", height: "50px", flexDirection: "column" }}>
                    ...
                    <div style={{ display: "flex", alignItems: "center", marginTop: "2rem" }}>
                        ...
                        <div style={{ display: "flex", marginLeft: "1rem", }}>
                            ...
                            <Link to="/privacy-policy" onClick={() => handleClick()} style={linkStyle}>
            ...
            :
            <div style={{ display: "flex", flexDirection: "column", alignItems: "center", marginTop: "6.6vmax", width: "96vw", overflow: "hidden" }}>
                <MailOutlineOutlinedIcon style={{ fontSize: `${80 / 1024 * props.width}px` }} />
                <Typography align="center" style={{ fontSize: `${55 / 1024 * props.width}px`, margin: "25px 0 20px" }}>
                    Stay up to date with all exclusive offers!
            </Typography>
                <div style={{ maxWidth: "300px", display: "flex", height: "50px", flexDirection: "column" }}>
                    <div style={{ display: "flex", height: "50px" }}>
                        <StyledTextFieldContactMobile helperText={valid(email) ? "" : "Email address required."} error={!valid(email)} onChange={(e) => setEmail(e.target.value)}
                            label="Email Address" variant="outlined" style={{ borderRadius: "0px" }} />
                        <div onClick={() => validate()} style={{
                            width: "fit-content", overflow: "hidden", position: "relative", borderTop: "1px solid black",
                            borderBottom: "1px solid black", borderRight: "1px solid black", display: "flex"
                            ...
                            <animated.div style={fillBoxSpring} />
                            <Button style={{ border: "2px solid white", borderRadius: "2px", background: "white", width: "100%" }} >
                                <Typography style={{ textAlign: "left", fontSize: `14px`, fontWeight: "600", color: hover ? "white" : "black", padding: "4px 4px", zIndex: 2 }}>
                                    Subscribe
                            </Typography>
                            </Button>
                        </div>
